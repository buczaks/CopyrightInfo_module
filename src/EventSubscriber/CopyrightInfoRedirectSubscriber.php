...
namespace Drupal\copyright_info\EventSubscriber;
 ...
 */
class CopyrightInfoRedirectSubscriber implements EventSubscriberInterface {
  ...
  /**
   * CopyrightInfoRedirectSubscriber constructor.
   *
  ...
  public function onRequest(RequestEvent $event) {
	...
	if ($route_name !== 'copyright_info.copy') {
      return;
    }
